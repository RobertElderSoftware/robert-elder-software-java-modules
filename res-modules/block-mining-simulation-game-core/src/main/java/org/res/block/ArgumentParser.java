...
class ArgumentParser {
	...
	private static List<ArgumentDescription> possibleArguments = Arrays.asList(
		...
		new ArgumentDescription("--print-user-interaction-config", 0, "Print the current configuration that describes which keys control the game."),
		new ArgumentDescription("--user-interaction-config-file", 1, "If specified, ignore the default built-in user interaction config and uses the one provided at file/path."),
