...
public class ClientBlockModelContext extends BlockModelContext implements BlockModelInterface, Comparable<InMemoryChunksClient>{
	...
	public ClientBlockModelContext(BlockManagerThreadCollection blockManagerThreadCollection, AuthorizedBlockWorldConnection authorizedBlockWorldConnection) throws Exception {
	...
	public void init(Object o) throws Exception{
		...
		this.blockManagerThreadCollection.addThread(new WorkItemProcessorTask<ChunkInitializerWorkItem>(getBlockManagerThreadCollection(), this.chunkInitializerThreadState, ChunkInitializerWorkItem.class, this.chunkInitializerThreadState.getClass()));
	...
	public void sendBlockMessage(BlockMessage m, BlockSession session) throws Exception{
		this.getSessionOperationInterface().sendBlockMessage(m, session);
	}
