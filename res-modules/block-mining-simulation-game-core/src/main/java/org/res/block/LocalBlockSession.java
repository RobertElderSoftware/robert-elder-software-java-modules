...
public class LocalBlockSession extends BlockSession {

	/*
		A local only 'session' object that satisfies the general requirement to keep track of a client session in the server classes.
	*/

	private String sessionId = null;
	private LocalBlockSession remoteSession = null;
	private BlockModelContext blockModelContext = null;
