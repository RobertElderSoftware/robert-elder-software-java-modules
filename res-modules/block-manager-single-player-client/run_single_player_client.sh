...
java -jar res-modules/block-manager-single-player-client/target/block-manager-single-player-client-0.0.2.jar --log-file /tmp/single-player-block-client.log --block-world-file /tmp/single-player-world.sqlite
