...
mvn -e -Dmaven.repo.local=${MVN_REPO} -pl res-modules/block-mining-simulation-game-unit-tests -amd clean compile package spring-boot:repackage &&
java -jar res-modules/block-mining-simulation-game-unit-tests/target/block-mining-simulation-game-unit-tests-${CURRENT_REVISION}.jar
