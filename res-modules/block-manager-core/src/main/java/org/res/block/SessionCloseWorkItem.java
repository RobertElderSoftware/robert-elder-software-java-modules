...
public class SessionCloseWorkItem extends BlockModelContextWorkItem {

	private BlockSession blockSession;
	private String reason;
	private boolean doClose;

	public SessionCloseWorkItem(BlockModelContext blockModelContext, String reason, BlockSession blockSession, boolean doClose){
