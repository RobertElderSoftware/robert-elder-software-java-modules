...
public enum BlockMessageType {
        BLOCK_MESSAGE_TYPE_READ_REGIONS (1L),
        BLOCK_MESSAGE_TYPE_SUBSCRIBE_REGIONS (2L),
        BLOCK_MESSAGE_TYPE_READ_AND_SUBSCRIBE_REGIONS (3L),
        BLOCK_MESSAGE_TYPE_DESCRIBE_REGIONS (4L);
