...
public class ProcessBlockMessageWorkItem extends BlockModelContextWorkItem {

	private BlockSession blockSession;
	private BlockMessage blockMessage;

	public ProcessBlockMessageWorkItem(BlockModelContext blockModelContext, BlockSession blockSession, BlockMessage blockMessage){
