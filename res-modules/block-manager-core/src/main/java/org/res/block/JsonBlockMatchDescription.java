...
public class JsonBlockMatchDescription extends BlockMatchDescription{
	...
	public JsonBlockMatchDescription(BlockModelContext blockModelContext, JsonElement e) {
		super(blockModelContext, e);
		JsonObject o = (JsonObject)e;
		this.jsonSchema =  new JsonSchema(blockModelContext, o.get("json_schema"));
	}
	...
	public boolean doesMatch(byte [] data) throws Exception{
		...
		try{
			...
			this.blockModelContext.logMessage("Caught exception trying to deserialize block, so it must not have been json.");
			return false;
		}
