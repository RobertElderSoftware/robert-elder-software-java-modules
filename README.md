...
```
java -jar block-mining-simulation-game-client-0.0.10.jar --help
```
...
```
java -jar block-mining-simulation-game-client-0.0.10.jar --compatibility-width 3
```
...
```
wget https://github.com/RobertElderSoftware/robert-elder-software-java-modules/releases/download/0.0.10/block-mining-simulation-game-client-0.0.10.jar
java -jar block-mining-simulation-game-client-0.0.10.jar
```
...
```
wget https://github.com/RobertElderSoftware/robert-elder-software-java-modules/releases/download/0.0.10/block-mining-simulation-game-client-0.0.10.jar.asc
...
gpg --verify block-mining-simulation-game-client-0.0.10.jar.asc block-mining-simulation-game-client-0.0.10.jar
```
...
```
./res-modules/block-mining-simulation-game-client/run_client.sh
```
...
```
-e -pl res-modules/block-mining-simulation-game-client -amd clean compile package spring-boot:repackage spring-boot:run
```
...
```
-Dspring-boot.run.arguments="--log-file=/tmp/block-client-intellij.log"
```
...
```
java -agentlib:jdwp=transport=dt_socket,address=5005,server=y,suspend=y -jar res-modules/block-mining-simulation-game-client/target/block-mining-simulation-game-client-0.0.10.jar --log-file /tmp/block-client.log --block-world-file /tmp/world.sqlite
```
