...
```
java -jar block-mining-simulation-game-client-0.0.9.jar --help
```
...
```
java -jar block-mining-simulation-game-client-0.0.9.jar --compatibility-width 3
```
...
```
wget https://github.com/RobertElderSoftware/robert-elder-software-java-modules/releases/download/0.0.9/block-mining-simulation-game-client-0.0.9.jar
java -jar block-mining-simulation-game-client-0.0.9.jar
```
...
```
wget https://github.com/RobertElderSoftware/robert-elder-software-java-modules/releases/download/0.0.9/block-mining-simulation-game-client-0.0.9.jar.asc
...
gpg --verify block-mining-simulation-game-client-0.0.9.jar.asc block-mining-simulation-game-client-0.0.9.jar
```
...
```
java -agentlib:jdwp=transport=dt_socket,address=5005,server=y,suspend=y -jar res-modules/block-mining-simulation-game-client/target/block-mining-simulation-game-client-0.0.9.jar --log-file /tmp/block-client.log --block-world-file /tmp/world.sqlite
```
